...
$tamsec = mysqli_query($con,"SELECT * FROM xeber where id='".$id."'");
...
<body>
    ...
    $sec = mysqli_query($con,"SELECT * FROM xeber where id='".$_GET['id']."'");
	...
	<div id="section-contents" class="post-detail-02">
		<div class="container">
			<div class="row">
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="block-style-17">
								<img style="width:769px; height:430px;" class="img-fluid" src="<?=$info['foto']?>"
									alt="Zola">
							</div>
							<!-- /.Block Style 17 -->
							<!-- Block Style 16 -->
							<div class="block-style-16">
								<h1 style="font-family: Tahoma, sans-serif;"><?=$info['title']?></h1>
								<div class="list-users-05">
									<ul class="images">
										<li><img src="assets/images/list_user1.jpg" alt="Zola"></li>
									</ul>
									<p><span>Bəybala Muxtarov</span></p>
				...
				<?php
                $sec = mysqli_query($con,"SELECT * FROM xeber ORDER BY tarix DESC LIMIT 1,6");
                $info = mysqli_fetch_array($sec);
                ?>
				<!-- Block Style 3, 4, 5 -->
				<div class="col-12 col-lg-4">
					<div class="block-style-10">
						<div class="block-title-1">
							<h3 style="font-family: Tahoma, sans-serif;">Ən son xəbərlər</h3>
						</div>
						<div class="small-list-posts">
                            ...
                            {
                            $title=mb_substr($info['title'],0,70);
                            ?>
							<div class="item">
								<a href="xeber.php?id=<?=$info['id']?>">

									<div class="thumbnail-img">
										<img style="width:80px; height:80px;" src="<?=$info['foto']?>" alt="Zola">
									</div>
									<div class="content">
										<h3><?=$title?></h3>
										<span><?=$info['tarix']?></span>
									</div>
								</a>
							</div>
							<?php
	...
	<!-- Section Contents -->
	<?php
    $sec = mysqli_query($con,"SELECT * FROM xeber where cat='".$taminfo['cat']."' ORDER BY tarix DESC LIMIT 4,22");
    $info = mysqli_fetch_array($sec);
    ?>
			...
			<div class="row">
				<div class="col-12">
					<div class="block-title-2">
						<h3 style="font-family: Tahoma, sans-serif;">Oxşar xəbərlər</h3>
					</div>
				</div>
				<?php
    			while($info = mysqli_fetch_array($sec))
					...
					<div class="block-style-12">
						...
						<div class="contents">
							...
							<div class="thumbnail-1">
								...
								<a href="xeber.php?id=<?=$info['id']?>">
									<img style="height:250px;" src="<?=$info['foto']?>" alt="Xebermedia">
								</a>
							</div>
							<!-- /.Thumbnail -->
							<!-- Content Wrapper -->
					...
					<div class="block-style-12">
						...
						<div class="contents">
							...
							<div class="thumbnail-1">
								...
								<a href="xeber.php?id=<?=$info['id']?>">
									<img style="height:250px;" src="<?=$info['foto']?>" alt="Zola">
								</a>
							</div>
							<!-- /.Thumbnail -->
							<!-- Content Wrapper -->

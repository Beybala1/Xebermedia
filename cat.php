...
<body>
    ...
    $sec = mysqli_query($con,"SELECT * FROM xeber where cat='".$_GET['cat']."' ORDER BY tarix DESC LIMIT 1,4");
	...
	<?php
    $sec = mysqli_query($con,"SELECT * FROM xeber where cat='".$_GET['cat']."' ORDER BY tarix DESC LIMIT 4,22");
    $info = mysqli_fetch_array($sec);
    ?>
	...
	<div id="section-contents">
		<div class="container">
			...
			<?php
            $sec = mysqli_query($con,"SELECT * FROM xeber ORDER BY tarix DESC LIMIT 21,2");
            $info = mysqli_fetch_array($sec);
            ?>
			...
			<?php
            $sec = mysqli_query($con,"SELECT * FROM xeber where cat='".$_GET['cat']."' ORDER BY tarix DESC LIMIT 25,22");
            $info = mysqli_fetch_array($sec);
            ?>

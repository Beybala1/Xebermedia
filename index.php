...
<body>
    ...
    <nav class="navbar-menu navbar navbar-expand-lg">
        <div class="container navbar-container">
            <!-- Logo -->
            <a class="navbar-brand background-logo" href="index.php"><img src="" alt="Zola"></a>
            <!-- /.Logo -->
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="cat.php?cat=Şou-biznes">Şou-biznes</a><a class="nav-link"
                            href="cat.php?cat=İdman">İdman</a><a class="nav-link"
                            href="cat.php?cat=İqtisadiyyat">İqtisadiyyat</a><a class="nav-link"
                            href="cat.php?cat=Ölkə">Ölkə</a><a class="nav-link"
                            href="cat.php?cat=Cəmiyyət">Cəmiyyət</a><a class="nav-link"
                            href="cat.php?cat=Dünya">Dünya</a><a class="nav-link"
                            href="cat.php?cat=QARABAĞ / SİYASƏT / G�">QARABAĞ / SİYASƏT / G�</a> </li>
                    <li class="nav-item dropdown-submenu dropdown">
                        <a class="dropdown-item dropdown-toggle nav-link" href="#" id="navbarSubDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Digər cateqoriyalar
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarSubDropdown">
                            <li><a href="cat.php?cat=Hadisə" class="dropdown-item">Hadisə</a></li>
                            <li><a href="cat.php?cat=Hadisə, Kriminal" class="dropdown-item">Hadisə, Kriminal</a></li>
                            <li><a href="cat.php?cat=Kriminal" class="dropdown-item">Kriminal</a></li>
                            <li><a href="cat.php?cat=Maraqlı" class="dropdown-item">Maraqlı</a></li>
                            <li><a href="cat.php?cat=Mədəniyyət" class="dropdown-item">Mədəniyyət</a></li>
                            <li><a href="cat.php?cat=MƏDƏNİYYƏT / Foto / V" class="dropdown-item">MƏDƏNİYYƏT / Foto /
                                    V</a></li>
                            <li><a href="cat.php?cat=Qafqaz" class="dropdown-item">Qafqaz</a></li>
                            <li><a href="cat.php?cat=QARABAĞ" class="dropdown-item">QARABAĞ</a></li>
                            <li><a href="cat.php?cat=QARABAĞ / GÜNDƏM" class="dropdown-item">QARABAĞ / GÜNDƏM</a></li>
                            <li><a href="cat.php?cat=QARABAĞ / SİYASƏT / G�" class="dropdown-item">QARABAĞ / SİYASƏT /
                                    G�</a></li>
                            <li><a href="cat.php?cat=Sağlamlıq" class="dropdown-item">Sağlamlıq</a></li>
                            <li><a href="cat.php?cat=Siyasət" class="dropdown-item">Siyasət</a></li>
                            <li><a href="cat.php?cat=Sosial" class="dropdown-item">Sosial</a></li>
                            <li><a href="cat.php?cat=Texnologiya" class="dropdown-item">Texnologiya</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    $sec = mysqli_query($con,"SELECT * FROM xeber ORDER BY tarix DESC LIMIT 1,4");
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="thumbnail-1 v1">
                            <a title="<?=$info['title']?>" href="xeber.php?id=<?=$info['id']?>">
    ...
    <?php
    $sec = mysqli_query($con,"SELECT * FROM xeber ORDER BY tarix DESC LIMIT 4,22");
    $info = mysqli_fetch_array($sec);
    ?>
    ...
    <div id="section-contents">
        <div class="container">
            ...
            <?php
            $sec = mysqli_query($con,"SELECT * FROM xeber ORDER BY tarix DESC LIMIT 25,22");
            $info = mysqli_fetch_array($sec);
            ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="block-style-12">
                        ...
                        <div class="contents">
                            <!-- Thumbnail -->
                            <div class="thumbnail-1">
                                <span style="font-family: Tahoma,sans-serif;" class="bg-yellow"><?=$info['cat']?></span>
                                <a title="<?=$info['title']?>" href="xeber.php?id=<?=$info['id']?>">
                                    <img style="height:250px;" src="<?=$info['foto']?>" alt="<?=$info['title']?>">
                                </a>
                            </div>
                ...
                <div class="col-12">
                    <div class="load-more-btn">
                        <form method="post">
                            <a class="btn" href="index.php">Daha çox</a>
                        </form>
